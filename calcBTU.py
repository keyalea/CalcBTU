...
#aWindowsE = float(input("What is the area of all the windows facing the east:")
#aWindowsW = float(input("What is the area of all the windows facing the west:")
#aWindowsS = float(input("What is the area of all the windows facing the south:")
#aWindowsN = float(input("What is the area of all the windows facing the north: ")
solCoolEW = float(input("\nWhat is the value for east-west facing windows: "))
...
solCoolLoad = float(windowsEW*solCoolEW) + float(windowsS*solCoolS) + float(windowsN*solCoolN)
q3 = windowArea*shadeCoEf*solCoolLoad
print("q3 is", q3)
