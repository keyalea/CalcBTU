...
print("\nHere's the temperature of the attic: " + str("%.2f" % atticTotal) + " (Reality check)")
...
# A requested change to gather input from user to have them calculate their own heatGain
...
print('You will need to compute the amount of heat gain generated by the total number of occupants.')
print('Refer to Table 4.5 *** Carlos!  Need this link!')
heatGain = float(input('Enter the amount of heat gain generated by the occupants: '))
# Previously, the equation was q7 = numPeeps*200
q7 = numPeeps*heatGain
